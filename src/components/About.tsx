                ...
                <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
                    ...
                    <div className="lg:w-1/2 w-full">
                        ...
                        <div className="flex gap-4 sm:gap-6 mb-8">
                            {stats.map((stat, i) => (
                                <div key={i} className="flex-1 text-center p-4 sm:p-6 bg-espelhart-surface rounded-xl border border-espelhart-accent/10">
                                    <span className="block text-2xl sm:text-3xl font-bold text-espelhart-medium">{stat.value}</span>
